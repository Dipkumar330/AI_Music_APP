...
describe('UsersController', () => {
  ...
  it('should be check find user details api', async () => {
    //Compare the actual response with the expected response
    await expect(controller.findOne('65b34473ab4f93d0ccb9d04f')).resolves.toEqual({
      _id: '65b34473ab4f93d0ccb9d04f',
      firstName: 'Jest',
      lastName: 'Test',
      gender: 'male',
  ...
  it('should be check update user details api', async () => {
    ...
    //Compare the actual response with the expected response
    await expect(controller.update('65b34473ab4f93d0ccb9d04f', body)).resolves.toEqual({
      _id: '65b34473ab4f93d0ccb9d04f',
      firstName: 'Jest',
      lastName: 'Test',
      gender: 'male',
  ...
  it('should be check delete user details api', async () => {
    //Compare the actual response with the expected response
    await expect(controller.remove('65b34473ab4f93d0ccb9d04f')).resolves.toEqual({
      _id: '65b34473ab4f93d0ccb9d04f',
      firstName: 'Jest',
      lastName: 'Test',
      gender: 'male',
